...
benchmarks = [
    ("192.0.2.0/24",   256,         "Small /24"),
    ("198.51.100.0/24",     4_096,       "Medium /20"),
    ("198.51.100.0/24",     65_536,      "/16 network"),
    ("192.0.2.0/24",    262_144,     "Large /14"),
    ("203.0.113.0/24",      1_048_576,   "Very large /12 (1M IPs)"),
]
