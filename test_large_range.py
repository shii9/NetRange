...
benchmarks = [
    ("172.16.10.0/24",   256,         "Small /24"),
    ("10.50.0.0/20",     4_096,       "Medium /20"),
    ("10.50.0.0/16",     65_536,      "/16 network"),
    ("172.16.0.0/14",    262_144,     "Large /14"),
    ("10.0.0.0/12",      1_048_576,   "Very large /12 (1M IPs)"),
]
